...
class TestBasics(base.BaseTestCase):
    def test_basics(self):
        ...
        expected = {
            ...
            "description": "A foobar project.",
            "long_description": "Hello, world. This is a long description.",
            "download_url": "http://opendev.org/x/pbr",
            "classifiers": [
                "Development Status :: 5 - Production/Stable",
                "Programming Language :: Python",
            ...
            "scripts": ["scripts/hello-world.py"],
            "py_modules": ["mod1"],
        }
...
class TestUTF8DescriptionFile(base.BaseTestCase):
    def test_utf8_description_file(self):
        ...
        unicode_description = "UTF8 description: é\"…-ʃŋ'\n\n"
