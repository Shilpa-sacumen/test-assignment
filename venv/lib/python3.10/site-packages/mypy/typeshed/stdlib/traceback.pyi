...
if sys.version_info >= (3, 10):
    ...
    @overload
    def format_exception(
        exc: BaseException, /, *, limit: int | None = None, chain: bool = True
    ) -> list[str]: ...
...
def format_list(
    extracted_list: Iterable[FrameSummary | _FrameSummaryTuple],
) -> list[str]: ...
...
if sys.version_info >= (3, 13):
    ...
    def format_exception_only(
        exc: BaseException | None, /, *, show_group: bool = False
    ) -> list[str]: ...
    @overload
    def format_exception_only(
    ...
    @overload
    def format_exception_only(
        exc: Unused, /, value: BaseException | None
    ) -> list[str]: ...
...
class TracebackException:
    ...
    if sys.version_info >= (3, 13):
        def format_exception_only(
            self, *, show_group: bool = False, _depth: int = 0
        ) -> Generator[str, None, None]: ...
    else:
...
class StackSummary(list[FrameSummary]):
    ...
    @classmethod
    def from_list(
        cls, a_list: Iterable[FrameSummary | _FrameSummaryTuple]
    ) -> StackSummary: ...
    if sys.version_info >= (3, 11):
