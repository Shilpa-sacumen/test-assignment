...
class array(MutableSequence[_T]):
    ...
    def __init__(
        ...
        initializer: bytes | bytearray | Iterable[int] = ...,
        /,
    ) -> None: ...
    @overload
    def __init__(
        ...
        initializer: bytes | bytearray | Iterable[float] = ...,
        /,
    ) -> None: ...
    @overload
    def __init__(
        ...
        initializer: bytes | bytearray | Iterable[str] = ...,
        /,
    ) -> None: ...
    @overload
    ...
    @overload
    def __init__(
        self, typecode: str, initializer: bytes | bytearray = ..., /
    ) -> None: ...
