...
class _GeneratorContextManager(
    AbstractContextManager[_T_co, bool | None], ContextDecorator
):
...
if sys.version_info >= (3, 10):
    ...
    class _AsyncGeneratorContextManager(
        AbstractAsyncContextManager[_T_co, bool | None], AsyncContextDecorator
    ):
...
_ACM_EF = TypeVar(
    "_ACM_EF", bound=AbstractAsyncContextManager[Any, Any] | _ExitCoroFunc
)
...
class AsyncExitStack(Generic[_ExitT_co], metaclass=abc.ABCMeta):
    ...
    async def enter_async_context(
        self, cm: AbstractAsyncContextManager[_T, _ExitT_co]
    ) -> _T: ...
    def push(self, exit: _CM_EF) -> _CM_EF: ...
...
if sys.version_info >= (3, 10):
    class nullcontext(
        AbstractContextManager[_T, None], AbstractAsyncContextManager[_T, None]
    ):
        enter_result: _T
        @overload
        ...
        @overload
        def __init__(
            self: nullcontext[_T], enter_result: _T
