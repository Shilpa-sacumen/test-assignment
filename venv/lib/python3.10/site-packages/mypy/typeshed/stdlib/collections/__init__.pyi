...
class UserDict(MutableMapping[_KT, _VT]):
    ...
    @overload
    def __init__(
        self: UserDict[str, str], iterable: Iterable[list[str]], /
    ) -> None: ...
    @overload
    def __init__(
        self: UserDict[bytes, bytes], iterable: Iterable[list[bytes]], /
    ) -> None: ...
...
class Counter(dict[_T, int], Generic[_T]):
    ...
    @overload
    def __init__(
        self: Counter[str], iterable: None = None, /, **kwargs: int
    ) -> None: ...
    @overload
...
class ChainMap(MutableMapping[_KT, _VT]):
    ...
    def fromkeys(
        cls, iterable: Iterable[_T], value: None, /
