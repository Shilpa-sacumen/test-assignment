...
_SrvnmeCbType: TypeAlias = Callable[
    [SSLSocket | SSLObject, str | None, SSLSocket], int | None
]
...
class SSLSocket(socket.socket):
    ...
    @overload
    def sendto(
        self, data: ReadableBuffer, flags_or_addr: socket._Address, addr: None = None
    ) -> int: ...
    @overload
    def sendto(
        self, data: ReadableBuffer, flags_or_addr: int, addr: socket._Address
    ) -> int: ...
...
class SSLContext:
    ...
    if sys.version_info >= (3, 10):
        ...
        def __new__(
            cls, protocol: int | None = None, *args: Any, **kwargs: Any
        ) -> Self: ...
    else:
    ...
    def set_servername_callback(
        self, server_name_callback: _SrvnmeCbType | None
    ) -> None: ...
