...
if sys.platform != "win32":
    ...
    if sys.platform != "darwin":
        ...
        def posix_fadvise(
            fd: int, offset: int, length: int, advice: int, /
        ) -> None: ...
    ...
    def preadv(
        fd: int,
        buffers: SupportsLenAndGetItem[WriteableBuffer],
        offset: int,
        flags: int = 0,
        /,
    ) -> int: ...
    def pwritev(
        fd: int,
        buffers: SupportsLenAndGetItem[ReadableBuffer],
        offset: int,
        flags: int = 0,
        /,
    ) -> int: ...
...
class _ScandirIterator(
    Iterator[DirEntry[AnyStr]], AbstractContextManager[_ScandirIterator[AnyStr], None]
):
...
def execl(
    file: StrOrBytesPath,
    *args: Unpack[tuple[StrOrBytesPath, Unpack[tuple[StrOrBytesPath, ...]]]],
) -> NoReturn: ...
def execlp(
    file: StrOrBytesPath,
    *args: Unpack[tuple[StrOrBytesPath, Unpack[tuple[StrOrBytesPath, ...]]]],
...
if sys.platform != "win32":
    ...
    def spawnve(
        mode: int, path: StrOrBytesPath, argv: _ExecVArgs, env: _ExecEnv, /
    ) -> int: ...
...
if sys.platform == "win32":
    ...
    if sys.platform != "darwin" or sys.version_info >= (3, 13):
        ...
        def waitid(
            idtype: int, ident: int, options: int, /
        ) -> waitid_result | None: ...
