...
class list(Generic[_T], Sequence[_T], Iterable[_T]):
    def __init__(self, i: Optional[Iterable[_T]] = None) -> None:
        pass
    ...
    def __mul__(self, i: int) -> List[_T]:
        pass

    def __rmul__(self, i: int) -> List[_T]:
        pass
    ...
    def count(self, _T) -> int:
        pass

    def extend(self, l: Iterable[_T]) -> None:
        pass
...
class dict(Mapping[_K, _V]):
    ...
    def setdefault(self, key: _K, val: _V = ...) -> _V:
        pass
...
class set(Generic[_T]):
    ...
    def update(self, x: Iterable[_S]) -> None:
        pass
...
@overload
def zip(
    x: Iterable[_T], y: Iterable[_S], z: Iterable[_V]
) -> Iterator[Tuple[_T, _S, _V]]:
    ...
